...
var AngularFireCartAdmin = angular.module("AngularFireCartAdmin", [ "ngRoute", "firebase" ]).value("fbURL", "https://ng-store.firebaseio.com/");
...
} ]), AngularFireCartAdmin.controller("ProductsCtrl", [ "$scope", "products", function($scope, products) {
    $scope.products = products.$asArray(), $scope.predicate = "-sku", $scope.categories = [ {
        name: "Berries"
    }, {
        name: "Cake Pops"
